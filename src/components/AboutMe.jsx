...
const AboutMe = () => {
    return (
        <div id="experience" className='border-b border-neutral-900 pb-4'>
            ...
            <div className='my-2 py-6 font-light grid lg:grid-cols-2 gap-12'>
                <motion.p
            ...
            <motion.p
                ...
                initial={{ opacity: 0, y: 100 }}
                transition={{ duration: 0.5 }}
                className='my-2 py-6 font-light text-justify'>I am now focusing on learning C# to develop and maintain ERP systems, while expanding my expertise in ethical hacking and security, with the goal of becoming a CTO or DevOps Manager.</motion.p>
        </div>
    )
}
