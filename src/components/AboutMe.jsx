...
const AboutMe = () => {
    return (
        <div id="experience" className='border-b border-neutral-900 pb-4'>
            <h2 className='my-20 text-center text-4xl'>Experience (<span className='text-neutral-500'>About ME</span>)</h2>

            <div className='my-2 py-6 font-light text-xl grid lg:grid-cols-2 gap-12'>
            ...
            <p className='my-2 py-6 font-light text-xl text-justify'>I am now focusing on learning C# to develop and maintain ERP systems, while expanding my expertise in ethical hacking and security, with the goal of becoming a CTO or DevOps Manager.</p>
        </div>
    )
}
